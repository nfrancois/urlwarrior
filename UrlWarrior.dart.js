...
var i=[]
processStatics(m)
x.push([q,p,j,i,o,k,l,n])}})([["","",,K,{
"^":"",
Iq:[function(){var z,y
z=window.location
z.hash="The Game is in the url. Press space to start ! Press 'H' for Help"
y=H.VM(new W.RO(window,"keyup",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new K.kl("The Game is in the url. Press space to start ! Press 'H' for Help",new K.zm(50,[],0,C.pr,!1),null,z,0).gx8()),y.el),[H.Kp(y,0)]).DN()},"$0","KW",0,0,0],
kl:{
"^":"a;QF,oF,pi,mW,bT",
...
y=this.oF
x=y.pl
if(x){if(typeof z!=="number")return H.s(z)
w=65<=z&&z<=90}else w=!1
if(w){y.dQ(z)
this.Vo()}else{x=!x
if(x&&z===32){y.Mm=[]
y.Ot=0
y.pl=!0
this.ty()}else if(x&&z===72)this.mW.hash="Press on your keyboard the letter which appears in the token. 1 point when you success, -2 when letter is absent. When there are more than 50 letters, you lose"}},"$1","gx8",2,0,7],
ty:function(){var z=this.pi
if(z!=null)z.Gv()
z=C.jn.BU(this.oF.Ot,5)
this.pi=P.SZ(P.k5(0,0,0,1000-C.jn.Z(90*z*z,z*z+4*z+1)*10,0,0),new K.TW(this))},
Vo:function(){var z=this.oF
z="Level="+this.bT+"_Score="+z.Ot+"#"+P.HM(z.Mm,0,null).toLowerCase()
this.mW.hash=z
return z}},
TW:{
"^":"Tp:8;a",
...
z=this.a
y=z.oF
if(y.pl){x=y.WC.j1(26)
y.Mm.push(x+65)
if(y.Mm.length>y.ng)y.pl=!1
z.Vo()
if(z.bT<C.jn.BU(y.Ot,5)){z.ty()
z.bT=C.jn.BU(y.Ot,5)}}else z.mW.hash="Level="+z.bT+"_Score="+y.Ot
return}},
zm:{
"^":"a;ng,Mm,Ot,WC,pl",
...
z=this.Ot
if(x===0)this.Ot=z-2
else this.Ot=z+(x+C.jn.BU(x,3)*5)}},
Py:{
"^":"Tp:8;a",
$1:function(a){var z=this.a
return z==null?a==null:z===a}}},1],["","",,H,{
"^":"",
FK:{
"^":"a;tT"}}],["","",,J,{
"^":"",
...
aX:{
"^":"a;jO,Gx,fW,En<,EE<,Qy,PX,xF,RW,C9,lJ,Jp,Jd,P0,pa,kJ",
...
"%":"DOMWindow|EventTarget|MediaStream|Window"},
HL:{
"^":"w6;",
...
init.metadata=[{func:"NT"},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"c0",args:[W.HL]},{func:"aB",args:[null]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},];$=null
